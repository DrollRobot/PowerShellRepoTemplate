...
- **Microsoft.PowerShell.PlatyPS** Official Microsoft tool for generating
  per-command markdown help from comment-based help.
...
- `Docs\` -- mkdocs content; `Docs\<ModuleName>\` is generated by Microsoft.PowerShell.PlatyPS.
