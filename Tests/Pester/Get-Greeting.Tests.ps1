...
.DESCRIPTION
    Demonstrates the testing conventions in AGENTS.md: offline tests carry no
    tag; tests that need a live external session are tagged 'Online'. The
    module is imported by Tests.ps1 before Pester runs.
